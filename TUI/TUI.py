    ...
    def print_hiscores(self, bucket) :
        ...
        for i in range(10):
            ...
            if buffer_bucket.next != None:    
                ...
                break
        header= "|Sæti         {:<{length:}}         Vinningar Ágiskanir  Dags      |".format("Nafn", length = name_len)
        print("|===============================================================|")
        print(header)
        print("|===============================================================|")
        buffer_bucket = bucket.top
        for i in range(10) :
            hiscore_list = buffer_bucket.data
            print("| {:3} ------- {:<{length:}} ------- {} ------- {:2} ------- {}|".format(i+1, hiscore_list[0], hiscore_list[1], hiscore_list[2], hiscore_list[3],length = name_len))
            if buffer_bucket.next != None:        
                buffer_bucket = buffer_bucket.next
            else :
                break
